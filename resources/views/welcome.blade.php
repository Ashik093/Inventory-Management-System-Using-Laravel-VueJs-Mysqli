  ...
  <body>
    <div id="app">
      <div class="hold-transition sidebar-mini layout-fixed">
        ...
        <div class="wrapper">
          <!-- Navbar -->
          <nav class="main-header navbar navbar-expand navbar-white navbar-light" v-show="$route.path ==='/' || $route.path === '/register' || $route.path === '/forgot-password'? false : true">
            <!-- Left navbar links -->
            <ul class="navbar-nav">
              <li class="nav-item">
          ...
          <aside class="main-sidebar sidebar-dark-primary elevation-4" v-show="$route.path ==='/' || $route.path === '/register' || $route.path === '/forgot-password'? false : true" >
            <!-- Brand Logo -->
            ...
            <div class="sidebar">
              ...
              <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                  ...
                  <li class="nav-item has-treeview">
                    <a href="#" class="nav-link">
                      <i class="far fa-arrow-alt-circle-right" style="font-size: 18px;margin-right: 7px;margin-left: 5px;"></i>
                      <p>
                        Category
                        <i class="right fas fa-angle-left"></i>
                      </p>
                  ...
                  <li class="nav-item has-treeview">
                    <a href="#" class="nav-link">
                      <i class="fas fa-dollar-sign" style="font-size: 18px;font-weight: bold;margin-right: 7px;margin-left: 9px;"></i>
                      <p>
                        Expense
                        <i class="right fas fa-angle-left"></i>
                      </p>
