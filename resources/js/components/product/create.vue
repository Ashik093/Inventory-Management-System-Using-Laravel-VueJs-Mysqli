	...
	<div>
		...
		<div class="card card-primary">
            <div class="card-header">
          		...
          		<router-link to="/all-product" class="btn btn-success btn-sm float-sm-right">All Product</router-link>
           	</div>
           	<div class="card-body">
           		<form @submit.prevent="insertProduct" method="post" enctype="multipart/form-data">
           			<div class="row">
           				<div class="col-md-6">
