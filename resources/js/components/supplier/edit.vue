	...
	<div>
		...
		<div class="card card-primary">
            <div class="card-header">
          		...
          		<router-link to="/all-supplier" class="btn btn-success btn-sm float-sm-right">All Supplier</router-link><router-link to="/add-supplier" class="btn btn-success btn-sm float-sm-right">Add Supplier</router-link>
           	</div>
           	<div class="card-body">
           		<form @submit.prevent="updateSupplier" method="post" enctype="multipart/form-data">
           			<div class="row">
           				<div class="col-md-6">
