	...
	<div>
		...
		<div class="card card-primary">
            <div class="card-header">
          		...
          		<router-link to="/all-employee" class="btn btn-success btn-sm float-sm-right">All Employee</router-link><router-link to="/add-employee" class="btn btn-success btn-sm float-sm-right">Add Employee</router-link>
           	</div>
           	<div class="card-body">
           		<form @submit.prevent="updateEmployee" method="post" enctype="multipart/form-data">
           			<div class="row">
           				<div class="col-md-6">
